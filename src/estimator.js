const covid19ImpactEstimator = (data) => {
  ...
  impact.hospitalBedsByRequestedTime = avail - impact.severeCasesByRequestedTime;
  ...
  severeImpact.hospitalBedsByRequestedTime = avail - severeImpact.severeCasesByRequestedTime;
  return {
    data,
    impact,
    severeImpact
